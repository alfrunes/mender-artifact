module github.com/alfrunes/mender-artifact/v4
...
require (
	...
	github.com/mendersoftware/mender-artifact v0.0.0-00010101000000-000000000000
...
replace github.com/mendersoftware/mender-artifact => ./
